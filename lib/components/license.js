...
(function() {
  var LicenseParser, Promise, fs, winston;
  ...
  module.exports = LicenseParser = (function() {
    ...
    LicenseParser.prototype.run = function(pkg) {
      ...
      winston.debug(" Reading license file from " + this.options.licenseFile);
      file = fs.readFileAsync(this.options.licenseFile, {
        encoding: this.options.encoding
      }).then((function(_this) {
        return function() {
          winston.debug("License file " + _this.options.licenseFile + " found");
